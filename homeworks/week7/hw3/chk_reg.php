...
$chk_stmt = $conn->prepare("SELECT username , nickname FROM $users_table WHERE username=:username OR nickname=:nickname");
...
if( $chk_stmt->rowCount() === 0 ){
	...
	$sql = "INSERT INTO $users_table (username, password, nickname) VALUES (:username, :password, :nickname)";
